...
cd redis-stable && make && make test && make install && mkdir /etc/redis && cp /tmp/redis-stable/redis.conf /etc/redis && rm -rf /tmp && apt-get autoclean && rm -rf /var/lib/apt/lists/* 
